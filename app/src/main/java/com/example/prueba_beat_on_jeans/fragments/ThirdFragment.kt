...
import com.example.prueba_beat_on_jeans.activities.ChatActivity
import com.example.prueba_beat_on_jeans.activities.MainActivity
import com.example.prueba_beat_on_jeans.adapters.ChatsAdapter
import com.example.prueba_beat_on_jeans.adapters.ImgChatsAdapter
                    ...
                    when(MainActivity.UserSession.rolId!!){
                        ...
                        2 ->{
                            chatList.forEach{ chat ->
                                ...
                                if(chat.mensajes.size != 0){
                                    val newChat = ChatRV(chat.id,user.nombre,chat.mensajes.last().mensaje,
                                        chat.mensajes[chat.mensajes.size-1].hora,false,
                                        R.drawable.hugo
                                    )
                                    chatRVList.add(newChat)
                                }else{
